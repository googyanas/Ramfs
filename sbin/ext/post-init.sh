...
case "$zzmoove_profile" in
  ...
  3)  
    ...
    ;;
     ...
     if "$scaling_governor" == "pegasusq";then
     ...
     if "$scaling_governor" == "lulzactiveq";then
...
#    chmod 777 /sys/vibrator/pwm_val
#    chown root root /sys/vibrator/pwm_val
#    chmod 777 /sys/vibrator/pwm_val
#    chown root root /sys/vibrator/pwm_val    
